class ChangeSubmissionFieldsToBoolean < ActiveRecord::Migration[8.0]
  FIELDS = %i[citation_verified abstract_provided dissertation_uploaded supplemental_files_uploaded permission_files_uploaded rights_selected format_reviewed].freeze
  def up
