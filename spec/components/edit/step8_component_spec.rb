...
RSpec.describe Edit::Step8Component, type: :component do
  ...
  context 'when all steps are not done' do
    ...
    it 'renders the component' do
      ...
      expect(page).to have_css('.alert-danger', text: 'You must complete sections 1-7')
  ...
  context 'when all steps are done' do
    ...
    it 'renders the component' do
      ...
      expect(page).to have_css('.alert-info', text: 'You have completed sections 1-7')
