...
RSpec.describe Edit::ButtonFormComponent, type: :component do
  ...
  it 'renders the component with a button' do
    render_inline(described_class.new(submission_presenter:, field: :citation_verified, value: 'true', label: 'Done'))

    expect(page).to have_css("form[action=\"/submissions/#{submission.dissertation_id}\"]")
  ...
  context 'with content' do
    it 'renders the component with a button' do
      render_inline(described_class.new(submission_presenter:, field: :citation_verified,
