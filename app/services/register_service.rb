...
class RegisterService
  ...
  def self.register(submission:)
    return submission if submission.druid.present?
    ...
    model_response = Dor::Services::Client.objects.register(params: request_model)

    submission.update(druid: model_response.externalIdentifier)
    submission
  end
end
